...
class DoingFragmentViewModel(private val appDataSource: AppDataSource) : ViewModel() {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    fun getTodoTaskList() {
        CoroutineScope(Dispatchers.IO).launch {
            _todoTaskList.postValue(taskDao.getTaskByFilter(currentUser.value?.username.toString(), TaskStatus.DOING))
        }
    }
